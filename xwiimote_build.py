...
#int XWII_LED(int num) {return (XWII_LED1 + (num) - 1);}
...
// this is a way to make line numbering easier to read
# 1 "xwiimote.h"

char* XWII__NAME = "Nintendo Wii Remote";

/** Name of the core input device */
char* XWII_NAME_CORE = "Nintendo Wii Remote";
/** Name of the accelerometer input device */
char* XWII_NAME_ACCEL = "Nintendo Wii Remote Accelerometer";
/** Name of the IR input device */
char* XWII_NAME_IR = "Nintendo Wii Remote IR";

/** Name of the motion-plus input device */
char* XWII_NAME_MOTION_PLUS = "Nintendo Wii Remote Motion Plus";
/** Name of the nunchuk input device */
char* XWII_NAME_NUNCHUK = "Nintendo Wii Remote Nunchuk";
/** Name of the classic-controller input device */
char* XWII_NAME_CLASSIC_CONTROLLER = "Nintendo Wii Remote Classic Controller";
/** Name of the balance-board input device */
char* XWII_NAME_BALANCE_BOARD = "Nintendo Wii Remote Balance Board";
/** Name of the pro-controller input device */
char* XWII_NAME_PRO_CONTROLLER = "Nintendo Wii Remote Pro Controller";
 ...
 */
static bool xwii_event_ir_is_valid(const struct xwii_event_abs *abs);
